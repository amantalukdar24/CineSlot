 ...
 body:new URLSearchParams({email,mode:"signin"})
  ...
  const handleSubmit=async ()=>{
    ...
    if(finalOtp.length<4) {
     ...
     setLoading(true);
    const result=await fetch(`${url}/admin/signin`,{
      method:"POST",
      headers:{
        "Content-Type":"application/x-www-form-urlencoded",
},
...
useEffect(() => {
  ...
  gutter={8} toastOptions={{duration:5000,    style: {
      ...
      <div className='w-[80vw] h-[50vh]  sm:w-[70vw] md:w-[60vw] lg:w-[50vw]   xl:w-[40vw]  lg:h-[60vh] flex flex-col  border-2 rounded-[40px] sm:rounded-[50px] shadow-[0.8px_8px_25px] shadow-blue-500  bg-gray-700 p-4'>
   ...
   { step===1 &&   <div>
     ...
     {step===1 &&    <div className='flex flex-row justify-center items-center gap-1 xl:gap-2 text-[0.8rem] sm:text-[1rem] md:text-[1.2rem] lg:text-[1.3rem] xl:text-[1.5rem] mt-10'>
