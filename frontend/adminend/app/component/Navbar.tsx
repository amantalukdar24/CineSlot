...
function Navbar() {
  ...
  return (
   ...
   {!auth &&  <Link href="/signin" ><button className='w-[25vw] sm:w-[20vw] md:w-[15vw] lg:w-[10vw] xl:w-[7vw] h-[5vh] bg-[black] cursor-pointer font-sans text-white sm:text-[0.8rem] md:text-[1rem] lg:text-[1.2rem] rounded-xl '>Sign in</button></Link> }
